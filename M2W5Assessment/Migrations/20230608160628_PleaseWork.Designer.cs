...
namespace M2W5Assessment.Migrations
{
    ...
    [Migration("20230608160628_PleaseWork")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConcertPerformers", b =>
                {
                    ...
                    b.HasKey("ConcertsId", "PerformersId")
                        .HasName("pk_concert_performers");

                    b.HasIndex("PerformersId")
                        .HasDatabaseName("ix_concert_performers_performers_id");

                    b.ToTable("concert_performers", (string)null);
                });
            ...
            modelBuilder.Entity("M2W5Assessment.Performers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ConcertPerformers", b =>
                {
                    b.HasOne("M2W5Assessment.Concert", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_concert_performers_concerts_concerts_id");

                    b.HasOne("M2W5Assessment.Performers", null)
                        .WithMany()
                        .HasForeignKey("PerformersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_concert_performers_performers_performers_id");
                });
